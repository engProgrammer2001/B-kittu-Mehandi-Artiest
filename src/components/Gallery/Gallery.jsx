    ...
    <div className="p-4">
      <div>
        ...
        <p className="px-4 lg:px-24 pt-4 pb-14 text-lg text-center text-gray-700">
          Welcome to Bkittu Mehandi Art Gallery, where every design is a
          masterpiece, weaving stories of tradition, elegance, and artistry. Our
          collection showcases intricate patterns and creative techniques,
          celebrating the beauty and grace of Mehandi. Each design reflects a
          unique blend of culture and imagination, crafted to adorn your special
          moments. Whether you're a bride-to-be, attending a celebration, or
          simply a Mehandi enthusiast, we invite you to explore our creations
          and find inspiration. Thank you for visiting Bkittu Mehandi Art, where
          every stroke celebrates the art of beauty!
        </p>
      </div>
